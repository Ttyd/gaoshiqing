...
//中间地图
  ...
  /*  $('#mapshow').append('<svg>'+
    ...
    /* drawLine(huaroudot1,daxingdot3,"Q80,100",{"stroke":"#6d9bfa","stroke-width":3,"arrow-end": "classic-wide-long"}).node.attributes["marker-end"].value = "url(#raphael-marker-endclassic-blue)";
